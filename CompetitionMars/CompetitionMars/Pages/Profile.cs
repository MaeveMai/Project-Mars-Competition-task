...
namespace CompetitionMars.Pages
{
    internal class Profile
    {
        ...
        private IWebElement AvailabilityTimeEditButton => driver.FindElement(By.XPath("//span[contains(text(),'Part Time')]//i[@class='right floated outline small write icon']"));
